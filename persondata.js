...
const personData = {
    ...
    skills: {
        dataEngineering: ['Python', 'SQL', 'Apache Spark', 'AWS', 'Docker'],
    ...
    hero: {
        title: {
            line1: 'Data Engineer',
            line2: '& Digital Artist'
        },
        subtitle: 'Transforming raw data into insights and pixels into stories. Bridging the gap between technical precision and creative expression.'
    },
    sections: {
        about: {
            title: 'About Me',
        ...
        dataEngineering: {
            ...
            subtitle: 'Building robust data solutions'
        },
        art: {
            title: 'Digital Art Portfolio',
            subtitle: 'Visual storytelling through pixels'
        },
        contact: {
            title: "Let's Connect",
